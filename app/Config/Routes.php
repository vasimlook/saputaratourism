...
$routes->add('admin/renew-hotel-ads-package', 'Hotel_c::renew_hotel_ads_package');
...
$routes->add('admin/make-top-package-payments', 'TopPackagePayment_c::make_top_package_payments');

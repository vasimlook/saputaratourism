					...
					<div class="row">
						<div class="col-md-6">
							<div class="strip grid">
								<figure>
									...
									<a href="<?php echo DETAILS_LINK.'0' ?>"><img src="img/location_1.jpg" class="img-fluid" alt="">
										<div class="read_more"><span>Read more</span></div>
									</a>
									<small>Restaurant</small>
								</figure>
								<div class="wrapper">
									<h3><a href="<?php echo DETAILS_LINK.'0' ?>">Da Alfredo</a></h3>
						...
						<div class="col-md-6">
							<div class="strip grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="<?php echo DETAILS_LINK.'0' ?>"><img src="img/location_2.jpg" class="img-fluid" alt="">
										<div class="read_more"><span>Read more</span></div>
									</a>
									<small>Bar</small>
								</figure>
								<div class="wrapper">
									<h3><a href="<?php echo DETAILS_LINK.'0' ?>">Limon Bar</a></h3>
						...
						<div class="col-md-6">
							<div class="strip grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="<?php echo DETAILS_LINK.'0' ?>"><img src="img/location_3.jpg" class="img-fluid" alt="">
										<div class="read_more"><span>Read more</span></div>
									</a>
									<small>Shop</small>
								</figure>
								<div class="wrapper">
									<h3><a href="<?php echo DETAILS_LINK.'0' ?>">Mary Boutique</a></h3>
						...
						<div class="col-md-6">
							<div class="strip grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="<?php echo DETAILS_LINK.'0' ?>"><img src="img/location_4.jpg" class="img-fluid" alt="">
										<div class="read_more"><span>Read more</span></div>
									</a>
									<small>Bar</small>
								</figure>
								<div class="wrapper">
									<h3><a href="<?php echo DETAILS_LINK.'0' ?>">Garden Bar</a></h3>
						...
						<div class="col-md-6">
							<div class="strip grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="<?php echo DETAILS_LINK.'0' ?>"><img src="img/location_5.jpg" class="img-fluid" alt="">
										<div class="read_more"><span>Read more</span></div>
									</a>
									<small>Hotel</small>
								</figure>
								<div class="wrapper">
									<h3><a href="<?php echo DETAILS_LINK.'0' ?>">Mariott Hotel</a></h3>
						...
						<div class="col-md-6">
							<div class="strip grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="<?php echo DETAILS_LINK.'0' ?>"><img src="img/location_6.jpg" class="img-fluid" alt="">
										<div class="read_more"><span>Read more</span></div>
									</a>
									<small>Event</small>
								</figure>
								<div class="wrapper">
									<h3><a href="<?php echo DETAILS_LINK.'0' ?>">Six Pistols</a></h3>

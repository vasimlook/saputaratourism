...
$table = 'saputara_facility_categories sp';
// Table's primary key
$primaryKey = 'sp.category_id';
...
$columns = array(      
    ...
    array('db' => 'sp.category_title', 'dt' =>'category_title'),   
...
echo json_encode(
       SSP::category_list($_REQUEST, $sql_details, $table, $primaryKey, $columns,$where)
);

...
$table = 'saputara_slider sp';
// Table's primary key
$primaryKey = 'sp.slider_id';
// Array of database columns which should be read and sent back to DataTables.
// The `db` parameter represents the column name in the database, while the `dt`
// parameter represents the DataTables column identifier. In this case simple
// indexes
$columns = array(      
    array('db' => 'sp.slider_id', 'dt' =>'slider_id'),
    array('db' => 'sp.slider_title', 'dt' =>'slider_title'),
    array('db' => 'sp.slider_image', 'dt' =>'slider_image'),   
    array('db' => 'sp.slider_position', 'dt' =>'slider_position'),       
...
echo json_encode(
       SSP::slider_list($_REQUEST, $sql_details, $table, $primaryKey, $columns,$where)
);

...
$table = 'saputara_facility_packages sp';
// Table's primary key
$primaryKey = 'sp.package_id';
...
$columns = array(      
    ...
    array('db' => 'sp.category_id', 'dt' =>'category_id'),
    array('db' => 'sp.package_title', 'dt' =>'package_title'),   
    array('db' => 'sp.package_duration', 'dt' =>'package_duration'),   
    array('db' => 'sp.package_price', 'dt' =>'package_price'),   
...
echo json_encode(
       SSP::package_list($_REQUEST, $sql_details, $table, $primaryKey, $columns,$where)
);
